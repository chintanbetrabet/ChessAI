        ...
        for cols in range(self.max_col):
            ...
            while i<self.max_row:              
                ...
                if begin==0 and self.Puzzle[pos].show==play:
                    begin=1
                if begin==1:
                    if self.Puzzle[pos].show==opp and count!=3:
...
def move1_do(puz,symbol):
    ...
    for x in move1:
        ...
        move2_do(move2,move3,move4,x,symbol,ind)
        ind+=1
    ret_ind=minimax(move4)
    
    return(move1[move2[move3[ret_ind][0]][0]])
def move2_do(move2,move3,move4,puz,symbol,ind):
    if symbol=='O':
        opp='X'
    else:
        opp='O'
    for i in range(puz.max_col):
        ...
        if do !=-1:
            ...
            move3_do(move3,move4,puz1,opp,len(move2)-1)
def move3_do(move3,move4,puz,symbol,ind):
    if symbol=='O':
        opp='X'
    else:
        opp='O'
    for i in range(puz.max_col):
        ...
        do=puz1.move(symbol,i)
        if do !=-1:
                move3.append([ind,puz1])
                move4_do(move4,puz1,opp,len(move3)-1)
def move4_do(move4,puz,symbol,ind):
    for i in range(puz.max_col):
        puz1=copy.deepcopy(puz)
        do=puz1.move(symbol,i)
        if do !=-1:
                move4.append([ind,puz1])
