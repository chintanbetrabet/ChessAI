...
class Board_State():
    ...
    def evaln(self,lev,color):
        ...
        return self.board_control(lev,color)*(20)+val
...
def Play1(player,board,color) :
    ...
    if player=='C':
        ...
        board=copy.deepcopy(Play_user(board,color))
    #board.display_board()
    print board.NoMoves
    return board  
